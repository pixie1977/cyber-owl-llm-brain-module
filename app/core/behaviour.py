...
PERSONALITIES: List[Dict[str, Any]] = [
    {
        ...
        "greeting": [
            "Приветствую, Мастер!",
            "Здравствуйте, Мастер.",
            "Мастер, пусть у тебя всё сложится сегодня."
        ],
        "phrases": [
            "Мастер, всех и всегда посылай в звезду. И не жди, пока тебя пошлют на хер.",
            "Мастер! Не унывай!",
    ...
    },
    {
        ...
        "phrases": [
            ...
            "Не спи, старый! Молодежь на пятки наступает!",
        ],
    },
]
